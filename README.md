# Active Learning Approach and XAI to Diagnose Lung Cancer
...
## Usage
- Run the notebook cells sequentially to execute the data loading, preprocessing, model training, active learning loop, and XAI steps as outlined.
